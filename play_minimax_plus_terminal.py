...
import env as game
import numpy as np
from minimax_plus_terminal_MCTS import minimax_plus_terminal_MCTS
import time
...
while not game_end:
    ...
    if current_player == mcts_player:
        # Use terminality_seeking_MCTS instead of VanillaMCTS
        mcts = minimax_plus_terminal_MCTS(n_iterations=20000, depth=5, exploration_constant=100, game_board=game_board, player=current_player)
