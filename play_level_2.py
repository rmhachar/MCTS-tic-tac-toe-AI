...
import env as game
import numpy as np
from terminality_seeking_MCTS import terminality_seeking_MCTS
import time
...
while not game_end:
    ...
    if current_player == mcts_player:
        ...
        mcts = terminality_seeking_MCTS(n_iterations=1500, depth=15, exploration_constant=100, game_board=game_board, player=current_player)
